    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow hover:shadow-lg transition-shadow">
      <div className="flex items-start justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold text-lg dark:text-gray-100">{goal.name || 'Unnamed Goal'}</h3>
            <div className="flex items-center gap-2">
              <p className="text-sm text-gray-600 dark:text-gray-400">{goal.category || 'General'}</p>
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex-1 bg-gradient-to-r from-green-600 to-emerald-600 text-white py-2 px-3 rounded-xl text-sm font-semibold hover:from-green-700 hover:to-emerald-700 transition-all"
        >
          Add Money
        </button>
        <button
          onClick={() => onEdit && onEdit(goal)}
          className="flex-1 bg-gradient-to-r from-blue-600 to-cyan-600 text-white py-2 px-3 rounded-xl text-sm font-semibold hover:from-blue-700 hover:to-cyan-700 transition-all"
        >
          Edit Goal
        </button>
      </div>
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 w-full max-w-md mx-4">
        <h3 className="font-bold text-xl mb-4 dark:text-gray-100">{goal ? 'Edit Goal' : 'Create New Goal'}</h3>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-1">Goal Name *</label>
            <input
              type="text"
              value={formData.name}
              onChange={(e) => setFormData({...formData, name: e.target.value})}
              className="w-full p-3 border dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-lg"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-1">Type</label>
              <select
                value={formData.type}
          ...
          <div>
            <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-1">Target Amount (₹) *</label>
            <input
              type="number"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-1">Start Date *</label>
              <input
                type="date"
            ...
            <div>
              <label className="block text-sm font-bold text-gray-700 dark:text-gray-200 mb-1">Deadline</label>
              <input
                type="date"
      ...
      <div id="goals-content" className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="font-bold text-gray-600 dark:text-gray-300">Total Goals</span>
            </div>
            <div className="text-2xl font-bold dark:text-gray-100">{goals.length}</div>
          </div>
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow">
            <div className="flex items-center gap-3 mb-2">
              <CheckCircle2 className="w-6 h-6 text-green-600" />
              <span className="font-bold text-gray-600 dark:text-gray-300">Completed</span>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="font-bold text-gray-600 dark:text-gray-300">In Progress</span>
            </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow">
            <div className="flex items-center gap-3 mb-2">
              ...
              <span className="font-bold text-gray-600 dark:text-gray-300">Total Value</span>
            </div>
        ...
        {goals.length > 0 ? (
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-12 shadow text-center">
            ...
            <h3 className="font-bold text-xl text-gray-600 dark:text-gray-300 mb-2">No Goals Yet</h3>
            <p className="text-gray-500 dark:text-gray-400 mb-6">Create your first financial goal to start tracking your progress</p>
            <button
              onClick={() => setShowForm(true)}
