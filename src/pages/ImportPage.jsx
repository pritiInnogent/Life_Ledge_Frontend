        ...
        {activeTab === "upload" && (
          <div className="space-y-8">
            <div className="text-center">
              <h2 className="text-2xl font-black mb-2 dark:text-gray-100">Upload Transaction Files</h2>
              <p className="text-gray-600 dark:text-gray-400">Support for PDF bank statements, CSV files, and transaction screenshots</p>
            </div>

            {/* File Upload Area */}
            <div className="border-2 border-dashed border-purple-300 dark:border-gray-600 rounded-2xl p-8 text-center hover:border-purple-500 dark:hover:border-purple-500 transition-colors bg-white/50 dark:bg-gray-700/50">
              <FileUp className="w-12 h-12 text-purple-500 mx-auto mb-4" />
              <h3 className="text-lg font-bold mb-2 dark:text-gray-100">Choose File to Upload</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-4">PDF, CSV, JPG, PNG files supported</p>
...
/>
            ...
            {selectedFile && (
              <div className="bg-gradient-to-r from-purple-50 to-cyan-50 dark:from-purple-900/20 dark:to-cyan-900/20 rounded-xl p-4 border border-purple-200 dark:border-purple-800">
                <p className="font-bold text-purple-800 dark:text-purple-300">Selected: {selectedFile.name}</p>
                <p className="text-sm text-purple-600 dark:text-purple-400">Size: {(selectedFile.size / 1024 / 1024).toFixed(2)} MB</p>
              </div>
            )}
            ...
            <div className="flex gap-4">
              <button
                ...
                className="flex-1 bg-gradient-to-r from-purple-600 to-cyan-600 hover:from-purple-700 hover:to-cyan-700 text-white px-8 py-4 rounded-xl font-bold shadow-lg shadow-purple-600/30 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {loading ? "Processing…" : "Process File"}
              </button>
              <button
                onClick={() => window.location.href = '/app/transactions'}
                className="px-6 py-4 bg-white dark:bg-gray-700 border-2 border-purple-600 dark:border-purple-500 text-purple-600 dark:text-purple-400 rounded-xl font-bold hover:bg-purple-50 dark:hover:bg-gray-600 transition-all duration-200 flex items-center gap-2"
              >
        ...
        {activeTab === "manual" && (
          <div className="space-y-8">
            <div className="text-center">
              <h2 className="text-2xl font-black mb-2 dark:text-gray-100">Add Transaction Manually</h2>
              <p className="text-gray-600 dark:text-gray-400">Enter transaction details manually</p>
            </div>

            {/* Account Dropdown */}
            <div>
              <label className="block text-sm font-bold mb-2 dark:text-gray-200">Select Bank Account *</label>
              <select
                className="w-full p-3 border dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-xl"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="block text-sm font-bold mb-2 text-gray-700 dark:text-gray-200">Date *</label>
                <input
                  type="date"
                  ...
                  className="w-full p-3 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
                />
              </div>

              <div>
                <label className="block text-sm font-bold mb-2 text-gray-700 dark:text-gray-200">Amount *</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full p-3 pl-8 border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 rounded-xl focus:ring-2 focus:ring-purple-500 focus:border-transparent transition-all"
                  />
                </div>
              </div>

              <div>
                <label className="block text-sm font-bold mb-2 text-gray-700 dark:text-gray-200">Transaction Type *</label>
                <select
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-bold mb-2 text-gray-700 dark:text-gray-200">Merchant *</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-sm font-bold mb-2 text-gray-700 dark:text-gray-200">Category *</label>
                <select
            ...
            <div className="bg-gray-50 dark:bg-gray-700 rounded-xl p-4">
              <h3 className="font-bold text-gray-700 dark:text-gray-200 mb-3">Additional Options</h3>
              <div className="flex flex-wrap gap-4">
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-sm font-medium text-gray-700 dark:text-gray-200">⚠️ Mark as Anomaly</span>
                </label>
              </div>
            </div>
            ...
            {/* Notes */}
            <div>
              <label className="block text-sm font-bold mb-2 text-gray-700 dark:text-gray-200">Notes</label>
              <textarea
